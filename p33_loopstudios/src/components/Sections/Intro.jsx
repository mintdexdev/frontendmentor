    ...
    <section>
      <Container>
        <div className=' pt-20 '>
          ...
          <div className='md:relative bg-red-300/20 md:min-h-[50vw] md:flex '>
            ...
            >
              ...
              <p className='font-semibold text-neutral-700 2xl:text-2xl'>Founded in 2011, Loopstudios has been producing world-class virtual reality projects for some of the best companies arounf the globe. Our award-winning creations habe transformed businesses through digital experiences that bind to their brand.</p>
            </div>
          </div>
